...
public final class RoundedNavigateButtons: RoundedButtonGroup {
    ...
    public init(
        ...
        let leftButton = IconOnlyButton(
            symbolName: Constants.chevronLeft,
            iconWidth: Constants.iconWidth,
            iconHeight: Constants.iconHeight,
            accessibilityLabel: leftAccessibilityLabel
        )
        leftButton.addAction(leftAction)

        let rightButton = IconOnlyButton(
            symbolName: Constants.chevronRight,
            iconWidth: Constants.iconWidth,
            iconHeight: Constants.iconHeight,
        ...
        frame = CGRect(x: 0, y: 0, width: 72, height: 0)
    }
}
