...
private extension FileVersionPicker {
    ...
    func addConstraints() {
        let constraints: [NSLayoutConstraint] = [
            ...
            navigateButtons.trailingAnchor.constraint(
                equalTo: topGuide.trailingAnchor,
                constant: -Constants.layoutPadding
            ),
            ...
            navigateButtons.heightAnchor.constraint(
                equalTo: versionMenuButton.heightAnchor,
                constant: modernStyle
                    ? 0
                    : -2
            ),

            modeMenuButton.trailingAnchor.constraint(
                equalTo: navigateButtons.leadingAnchor,
                constant: -Constants.layoutPadding
            ),
            modeMenuButton.centerYAnchor.constraint(equalTo: topGuide.centerYAnchor),

            versionMenuButton.leadingAnchor.constraint(
                equalTo: topGuide.leadingAnchor,
                constant: Constants.layoutPadding
            ),
            versionMenuButton.centerYAnchor.constraint(equalTo: topGuide.centerYAnchor),
            versionMenuButton.trailingAnchor.constraint(
                equalTo: modeMenuButton.leadingAnchor,
                constant: -Constants.layoutPadding
            ),

            selectButton.trailingAnchor.constraint(
                equalTo: bottomGuide.trailingAnchor,
                constant: -Constants.layoutPadding
            ),
    ...
    func resetVersionMenu() {
        ...
        if
            let index = (versionMenuButton.menu?.items.firstIndex {
