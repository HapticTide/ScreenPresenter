...
enum Localized {
    enum General {
        ...
        static let insertLineBreak = String(
            localized: "Insert Line Break",
            comment: "Insert a line break into the current editor"
        )
    }

    enum Editor {
        static let controlCharacter = String(
            localized: "Control Character",
            comment: "Phrase used in CodeMirror to indicate control character"
        )
        static let foldedLines = String(
            localized: "Folded Lines",
            comment: "Phrase used in CodeMirror to indicate folded lines"
        )
        static let unfoldedLines = String(
            localized: "Unfolded Lines",
            comment: "Phrase used in CodeMirror to indicate unfolded lines"
        )
        static let foldedCode = String(
            localized: "Folded Code",
    ...
    enum Toolbar {
        static let tableOfContents = String(
        ...
        static let toggleStrikethrough = String(
            localized: "Strikethrough",
            comment: "Toolbar item to toggle strikethrough"
        )
        static let toggleInlineCode = String(
            localized: "Inline Code",
            comment: "Toolbar item to toggle inline code"
        )
        ...
        static let toggleBullet = String(localized: "Bulleted List", comment: "Toolbar item to toggle bullet list")
        ...
        static let horizontalRule = String(
            localized: "Horizontal Rule",
        ...
        static let shareDocument = String(
            localized: "Share this document",
            comment: "Toolbar item to share the document"
        )
        static let copyPandocCommand = String(
            localized: "Copy Pandoc Command",
            comment: "Toolbar item to copy pandoc command"
        )
        static let preview = String(localized: "Preview", comment: "Toolbar item to toggle markdown preview")
        static let edit = String(localized: "Edit", comment: "Toolbar item to exit preview mode and edit")
    }
    ...
    enum Search {
        ...
        static let diacriticInsensitive = String(
            localized: "Diacritic Insensitive",
        ...
        static let regularExpression = String(
        ...
        static let selectAllInSelection = String(
            localized: "Select All in Selection",
        ...
        static let replaceAllInSelection = String(
            localized: "Replace All in Selection",
        ...
        static let selectAllOccurrences = String(
            localized: "Select All Occurrences",
    ...
    enum Document {
        static let untitled = String(localized: "Untitled", comment: "Default file name for new unsaved documents")
        ...
        static let gotoLineHelp = String(
            localized: "Enter the line number and hit return",
        ...
        static let showHiddenFiles = String(
    ...
    enum Settings {
        ...
        static let openFontPanel = String(
            localized: "Open Font Panel…",
        ...
        static let getCustomThemes = String(
            localized: "Get Custom Themes…",
        ...
        static let activeLineIndicator = String(
            localized: "Active line indicator",
        ...
        static let renderInvisibles = String(
            localized: "Render Invisibles:",
        ...
        static let editBehavior = String(
            localized: "Edit Behavior:",
            comment: "Editor behavior like focus mode and typewriter mode"
        )
        static let typewriterModeTitle = String(
            localized: "Keep caret in the middle",
        ...
        static let lineWrappingDescription = String(
            localized: "Wrap lines to editor width",
        ...
        static let insertsFourSpaces = String(
            localized: "Inserts 4 spaces",
        ...
        static let insertFinalNewline = String(
            localized: "Insert final newline",
            comment: "Option for inserting newline at end of file"
        )
        static let trimTrailingWhitespace = String(
            localized: "Trim trailing whitespace",
            comment: "Option for trimming trailing whitespaces"
        )
        static let fileFormattingHint = String(
            localized: "Format when saving files.",
        ...
        static let wordsInDocument = String(
            localized: "Words in document",
        ...
        static let completionHint = String(
            localized: "Press ⌥ ⎋ to show the panel.",
        ...
        static let inlinePredictions = String(
            localized: "Inline Predictions",
            comment: "Whether to allow inline predictions"
        )
        static let suggestWhileTyping = String(
            localized: "Suggest while typing",
        ...
        static let newWindowBehavior = String(
            localized: "New Window Behavior:",
            comment: "Behavior when creating new windows"
        )
        static let windowRestoration = String(
            localized: "Window Restoration:",
            comment: "Label for window restoration options"
        )
        static let quitAlwaysKeepsWindows = String(
            localized: "Quit always keeps windows",
            comment: "Whether to keep windows when quit the app"
        )
        static let newFilenameExtension = String(
            localized: "New Filename Extension:",
            comment: "Filename extension for new files"
        )
        static let defaultTextEncoding = String(
            localized: "Default Text Encoding:",
            comment: "Text encoding for opening and saving files"
        )
        static let defaultLineEndings = String(
            localized: "Default Line Endings:",
            comment: "Line endings for creating new files"
        )
        static let macOSLineEndings = String(
            localized: "macOS / Unix (LF)",
        ...
        static let classicMacLineEndings = String(
            localized: "Classic Mac OS (CR)",
        ...
        static let reduceTransparencyLabel = String(
            localized: "Reduce Transparency:",
            comment: "Label for the option to reduce window transparency"
        )
        static let reduceTransparencyDescription = String(
            localized: "Remove the toolbar blur",
            comment: "Explanation for the option to reduce window transparency"
        )
    }

    enum FileVersion {
        static let revertTitle = String(
            localized: "Revert to This Version",
        ...
        static let noVersionsTitle = String(
            localized: "No versions match the specified condition.",
            comment: "Alert title for no versions found"
        )
        static let foundVersionsFormat = String(
            localized: "Found %lld versions, would you like to delete them?",
            comment: "Alert title (format) for number of versions found"
        )
        static let cannotBeUndone = String(
    ...
    enum Scripting {
        static let missingCommandErrorMessage = String(
            localized: "Couldn’t find a command to handle incoming Apple Event.",
            comment: "Script error when ScreenPresenter has no command to handle the incoming Apple Event"
        )
        static let missingArgumentErrorMessage = String(
            localized: "Argument “%@” not found in event descriptor, the descriptor is likely malformed.",
            comment: "Script error when a command argument is missing due to a corrupted Apple Event"
        )
        static let editorNotFoundErrorMessage = String(
            localized: "No editor for document “%@” found.",
            comment: "Script error when ScreenPresenter cannot find the editor view to run document commands in"
        )
        static let jsEvaluationErrorMessage = String(
            localized: "JavaScript evaluation failed at line %d, column %d: %@",
            comment: "Script error when JavaScript evaluation raises a detailed error"
        )
        static let unknownJSErrorMessage = String(
            localized: "JavaScript evaluation failed for an unknown reason.",
            comment: "Script error when JavaScript evaluation raises an error with no details"
        )
        static let invalidDestinationErrorMessage = String(
            localized: "Cannot export files with extension “%@”, supported extensions: %@.",
            comment: "Script error when attempting to save files with an unsupported extension"
        )
        static let extensionMismatchErrorMessage = String(
            localized: "Wrong file extension for type “%@”, use “.%@” instead.",
    ...
    enum Updater {
        ...
        static let upToDateMessage = String(
            localized: "ScreenPresenter %@ is currently the latest version.",
            comment: "Message for the up-to-date info"
        )
        static let newVersionAvailable = String(
            localized: "ScreenPresenter %@ is available!",
            comment: "Title for new version available"
        )
        static let updateFailedTitle = String(
            localized: "Failed to get the update.",
            comment: "Title for failed to get the update"
        )
        static let updateFailedMessage = String(
            localized: "Please check your network connection or get the latest release from the version history.",
            comment: "Message for failed to get the update"
        )
        static let needsOSUpdateMessage = String(
            localized: "This release requires macOS %@ or later and cannot be installed without upgrading your operating system.",
        ...
        static let viewReleasePage = String(
            localized: "View Release Page",
        ...
        static let remindMeLater = String(
            localized: "Remind Me Later",
            comment: "Title for the \"Remind Me Later\" button"
        )
        static let skipThisVersion = String(
            localized: "Skip This Version",
            comment: "Title for the \"Skip This Version\" button"
        )
        static let disableUpdateChecks = String(
            localized: "Disable Update Checks",
            comment: "Title for the \"Disable Update Checks\" button"
        )
        static let checkVersionHistory = String(
            localized: "Check Version History",
