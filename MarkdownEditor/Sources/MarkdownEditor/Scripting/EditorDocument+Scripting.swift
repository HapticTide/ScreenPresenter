...
extension EditorDocument {
    ...
    @objc var scriptingSelectedText: String {
        get {
            guard
                let command = currentScriptCommand(),
...
private extension NSAppleEventDescriptor {
    ...
    convenience init(dictionary: [String: Any]) {
        ...
        for (key, value) in dictionary {
             ...
             */
            let keyASUserRecordFields: UInt32 = 1_970_500_198
    ...
    convenience init(with value: Any?) {
        ...
        case let intValue as Int32:
            ...
            if
                mirror.subjectType != Mirror(reflecting: NSNumber(value: intValue)).subjectType,
                let booleanResult = value as? Bool {
