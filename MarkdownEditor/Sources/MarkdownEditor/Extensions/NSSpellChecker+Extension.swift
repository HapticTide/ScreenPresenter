    ...
    enum InlineCompletion {
        static var webKitEnabled: Bool {
            if NSSpellChecker.supportsInlineCompletion {
                ...
                AppPreferences.Assistant.inlinePredictions
            }
        }
        ...
        fileprivate static let showCompletionSelector =
            sel_getUid("showCompletionForCandidate:selectedRange:offset:inString:rect:view:completionHandler:")
    }
    ...
    @MainActor static let swizzleShowCompletionForCandidateOnce: () = {
        NSSpellChecker.exchangeInstanceMethods(
            ...
            swizzledSelector: #selector(
                swizzled_showCompletion(for:selectedRange:offset:inString:rect: view:completionHandler:)
            )
        )
    }()
        ...
        NSSpellChecker.exchangeInstanceMethods(
            ...
            swizzledSelector: #selector(
                swizzled_showCorrectionIndicator(
                    of:primaryString:alternativeStrings:forStringIn:view:completionHandler:
                )
            )
        )
    }()
