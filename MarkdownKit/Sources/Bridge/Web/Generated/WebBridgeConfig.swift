...
public final class WebBridgeConfig {
    ...
    public func setShowActiveLineIndicator(
        enabled: Bool,
    ...
    public func setInvisiblesBehavior(
        behavior: EditorInvisiblesBehavior,
        completion: ((Result<Void, WKWebView.InvokeError>) -> Void)? = nil
    ) {
        struct Message: Encodable {
    ...
    public func setDefaultLineBreak(
        lineBreak: String?,
        completion: ((Result<Void, WKWebView.InvokeError>) -> Void)? = nil
    ) {
        struct Message: Encodable {
    ...
    public func setSuggestWhileTyping(
        enabled: Bool,
        completion: ((Result<Void, WKWebView.InvokeError>) -> Void)? = nil
    ) {
        struct Message: Encodable {
