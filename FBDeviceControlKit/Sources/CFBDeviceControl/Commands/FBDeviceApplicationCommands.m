...
// FBDeviceControl-Swift.h excluded - FBAppleDevicectlCommandExecutor not available
...
{
    // Note: iOS 17+ devicectl path disabled - FBAppleDevicectlCommandExecutor not available in this build
    // For iOS 17+, this will fall back to the instruments client path
    {
        return [[[self
